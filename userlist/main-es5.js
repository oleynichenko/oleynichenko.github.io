...
var apiUrl = 'https://indigo-conf.herokuapp.com/api';
var API_URL = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('API_URL');
// API endpoints
var ApiUrl = {
    get users() {
        return apiUrl + "/users";
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getUsers = function (offset, limit) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set("offset", offset.toString())
            .set("limit", limit.toString());
        // second request made in order to receive total number of users. Should be changed in future
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["zip"])(this.http.get(this.ApiUrl.users, { params: params }), this.http.get(this.ApiUrl.users).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return data.length; })));
    };
    DataService.prototype.getUserById = function (id) {
        return this.http.get(this.ApiUrl.user(id));
    };
    DataService.prototype.saveUser = function (id, user) {
...
var DeleteUserComponent = /** @class */ (function () {
    function DeleteUserComponent(data) {
        this.data = data;
    }
...
var ServerErrorInterceptor = /** @class */ (function () {
    function ServerErrorInterceptor(snackBar) {
        this.snackBar = snackBar;
    }
    ServerErrorInterceptor.prototype.intercept = function (req, next) {
        var _this = this;
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            // depending on details in ApiError should be more advanced logic
            var message = error.error
                ? error.error.title
                : error.message;
            _this.snackBar.open(message, 'Close', { duration: 10000 });
...
var AddUserComponent = /** @class */ (function () {
    function AddUserComponent(router, dataService, snackBar, dialog) {
        this.router = router;
    ...
    // creating user
    AddUserComponent.prototype.onAddFormSubmit = function () {
        var _this = this;
        this.dataService.createUser({
            ...
            _this.snackBar.open('User created', 'Close', { duration: 3000 });
            _this.router.navigate(["/users/" + _this.addForm.value.id]);
        });
    };
    // cancel user creating
    AddUserComponent.prototype.cancelUser = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_shared_delete_user_component__WEBPACK_IMPORTED_MODULE_7__["DeleteUserComponent"], {
            data: {
...
var UserListComponent = /** @class */ (function () {
    function UserListComponent(router, snackBar, dataService) {
        this.router = router;
        this.snackBar = snackBar;
        this.dataService = dataService;
        this.limit = 10;
    ...
    UserListComponent.prototype.onCardClick = function (id) {
        if (id === '') {
    ...
    UserListComponent.prototype.getUsers = function (event) {
        var _this = this;
        var limit = event ? event.pageSize : this.limit;
        var offset = event ? (event.pageIndex) * limit : 0;
        this.dataService.getUsers(offset, limit).subscribe(function (data) {
            _this.users = data[0];
            _this.totalCount = data[1];
        });
    };
...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(route, router, dataService, snackBar, dialog) {
        this.route = route;
        this.router = router;
        this.dataService = dataService;
        this.snackBar = snackBar;
    ...
    UserProfileComponent.prototype.ngOnInit = function () {
        ...
        this.route.data.subscribe(function (data) {
            ...
            _this.profileForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    UserProfileComponent.prototype.deleteUser = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_shared_delete_user_component__WEBPACK_IMPORTED_MODULE_6__["DeleteUserComponent"], {
            data: {
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.dataService.deleteUser(_this.userId).subscribe(function (data) {
                    _this.snackBar.open('User was successfully deleted', 'Close', { duration: 3000 });
                    _this.router.navigate(['/users']);
                });
            }
        });
    ...
    // saving user
    UserProfileComponent.prototype.onProfileFormSubmit = function () {
        var _this = this;
        this.dataService.saveUser(this.userId, {
            ...
            _this.userWasChanged = false;
            _this.snackBar.open('User is successfully saved', 'Close', { duration: 3000 });
        });
    };
    // check form input values changes to make 'save' button active
    UserProfileComponent.prototype.onValueChange = function () {
        if (!this.userWasChanged) {
            this.userWasChanged = true;
        }
    };
    UserProfileComponent.prototype.backToUsers = function () {
        var _this = this;
...
var UserResolver = /** @class */ (function () {
    function UserResolver(dataService, ApiUrl) {
        this.dataService = dataService;
        this.ApiUrl = ApiUrl;
    }
